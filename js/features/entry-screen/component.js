  ...
  render() {
    ...
    return (
      <View style={style.container}>
        ...
        <TouchableOpacity onPress={pushNotificationPrompt} style={style.textView}>
          <Text style={style.text}>Prompt Push Notifications (Device Only)</Text>
        </TouchableOpacity>
      </View>
    );
  }
...
Entry.propTypes = {
  ...
  pushNotificationPrompt: PropTypes.func.isRequired,
};
